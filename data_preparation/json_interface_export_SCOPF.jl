...
# global s_res=Dict(:OPF_bra_active_normal => active_line_flow_normal, # <--- skipped to save time
...
#        :OPF_Qgen_neg_con=>qgen_neg_c
#        )
#  stringdata = JSON.json(s_res)
# #Please note that parallel lines are merged initially,
# # io = open("export_WP3.json", "a");

# # # Delete old JSON file before saving new data
# if isfile("data_preparation\\export_WP3.json")
#     rm("data_preparation\\export_WP3.json")
