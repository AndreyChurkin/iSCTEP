...
global sbase = nw_sbase[1].sbase     # sbase is in MVA
...
function arrays_2(Load_MAG) # updates data for iterative coalitional analysis but does not touch load profiles
    nw_sbase = array_sbase
    global sbase = nw_sbase[1].sbase     # sbase is in MVA
    #--------------- Active and reactive power load profiles -----------------------
    # nw_pPrf_header_load     = rheader_pProfile_load
